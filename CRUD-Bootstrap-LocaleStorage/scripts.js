...
newUserBtn.addEventListener('click', () => {
    submitBtn.innerText = 'Salvar',
        modalTitle.innerText = "Preencher Formulário"
    isEdit = false
...
function editInfo(index, pic, name, Age, City, Email, Phone, Post, Sdate) {
    ...
    modalTitle.innerText = "Atualizar Formulário"
}


function deleteInfo(index) {
    if (confirm("Tem certeza que deseja apagar as informações dessa pessoa?")) {
